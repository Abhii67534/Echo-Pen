...
import { emailState, passwordState, quoteState, usernameState } from "@/recoil/atom";
...
export const Signup = () => {
    ...
    const handleClick = async () => {
        ...
        try {
            const response = await axios.post("https://backend.abhisharma4950.workers.dev/user/signup", formData, {
                headers: {
        ...
        <div className="flex h-screen justify-center">
            ...
            <div className="md:w-1/2 bg-white flex justify-center flex-col">
                <div className="flex items-center flex-col">
                    ...
                    <div className="mt-5 ">
                        <Button variant="ghost" className="xs:w-[100px] tab:w-[150px] xl:w-[200px]" onClick={handleClick}>Sign Up</Button>
                    </div>
                </div>
            </div>
                ...
                <div className="flex items-center flex-col">
                    {quote && (
                        <div className="md:text-xl xl:text-2xl font-bold tracking-tight m-4 text-center">
                            <p>"{quote.quote}"</p>
                            <p className="mt-2 md:text-sm lg:text-md italic font-normal">—{quote.author}</p>
                        </div>
                    )}
                </div>
            </div>
